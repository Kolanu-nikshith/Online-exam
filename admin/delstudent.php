  ...
  <br>
   <div class="row" style="margin-top: 20px;">
        ...
        <div class="col-lg-8" >
          ...
          <?php 
           $query1 = "SELECT sname,sid FROM student ORDER BY sid";
      ...
      <div class="modal-body">
        ...
        <form role="form" name="delf" id="delf" method="POST">
            ...
            <div class="input-group">
              ...
              <input type="text" disabled name="fid" id="fid"  class="form-control" placeholder="Employee ID" value=<?php 
                      $facuname="";
                                      ...
                                      $query1 = "SELECT sid FROM student where sid='$facuname'";
                                        if ($result1=mysqli_query($db,$query1))
                                        {
                                                  // Fetch one and one row
                                         while ($row=mysqli_fetch_row($result1))
            ...
            <div class="input-group">
              ...
              <input type="text" name="fname" id="fname" class="form-control" placeholder="Enter Full Name" value=<?php 
                      $facuname="";
                                      ...
                                      $query1 = "SELECT sname FROM student where sid='$facuname'";
                                        if ($result1=mysqli_query($db,$query1))
                                        {
                                                  // Fetch one and one row
                                         while ($row=mysqli_fetch_row($result1))
            ...
            <div class="input-group">
              ...
              <input type="email" class="form-control" id="email" name="email" placeholder="Email address" value=<?php 
                      $facuname="";
                                      ...
                                      $query1 = "SELECT email FROM student where sid='$facuname'";
                                        if ($result1=mysqli_query($db,$query1))
                                        {
                                                  // Fetch one and one row
                                         while ($row=mysqli_fetch_row($result1))
          ...
          <div class="form-group text-center">
            <button type="submit" class="btn " id="updatestu" name="updatestu" style="background-color: #fb641b;">update student</button>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="text-center">
                                    ...
                                    <?php   if (isset($_GET['name'])) {
                                       $facuname =$_GET['name'];
                                       $facdetails="";
                                        $query1 = "SELECT sid,email,batch,department FROM student where sid='$facuname'";
                                        if ($result1=mysqli_query($db,$query1))
                                        {
                                                  // Fetch one and one row
                                         while ($row=mysqli_fetch_row($result1))
                                ...
                                <li>
                                    ...
                                    <form method="post">
                                        <input type="submit" class="btn btn-danger text-center btn-block" name="delstu" id="delstu" value="delete" /><br/>
                                    </form>
                                    ...
                                    function testfun()
                                    {
                                        ...
                                        $query = "DELETE FROM student WHERE sid='$facuname'";
                                        mysqli_query($db, $query);
                                        echo '<script language="javascript">';
                                        echo 'alert("delete student successful!")';
                                        echo '</script>';
                                           echo "<script type='text/javascript'>window.location.href='delstudent.php'</script>";
                                    ...
                                    if(array_key_exists('delstu',$_POST)){
                                       testfun();
                                    }
                                 ...
                                 <li>
                                    <button class="btn btn-success text-center btn-block"  id="editfacbtn" onclick="editstudent()">Edit details</button>
                                </li>
                            </ul></div>
                        </div>
                    </div>
...
//        alert($(this).text());
       ...
       var arr = facname.split('-');
        facid = arr[0];    
       //window.alert(arr[0]);
        window.location.href = "delstudent.php?name="+facid; 
    });
